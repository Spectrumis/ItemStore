...
public class RedBlackTree < E
 ...
 public ArrayList<E> FindAll(E target,ArrayList<E> data){
   return  FindAll(null,target,data);
 }
  private ArrayList<E> FindAll(Node < E > localRoot, E target ,ArrayList<E> data ) {
